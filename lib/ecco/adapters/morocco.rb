module Ecco
  class MoroccoAdapter < Adapter
    ...
    def initialize
      ...
      @article_block = get_html(root_uri).css('.td-module-thumb')
      @article_url =  article_url =  article_block.css('a')[1].attr('href')
    ...
    def data
      return SiteData.new(
        ...
        image_url: URI.parse(article_block.css('img')[1].attr('src')),
